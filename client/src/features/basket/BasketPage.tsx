    ...
    return (
        <>
                            ...
                            <TableRow key={item.productId} sx={{ '&:last-child td, &:last-child th': { border: 0 } }}>
                                ...
                                <TableCell align="center">
                                    ...
                                    <LoadingButton
                                        ...
                                        onClick={() =>
                                            handleRemoveItem(
                                                item.productId, 1, 'rem' + item.productId)}
                                        color='error'>
                                        <Remove />
                                    </LoadingButton>
                                    ...
                                    <LoadingButton
                                        ...
                                        onClick={() =>
                                            handleAddItem(
                                                item.productId, 'add' + item.productId)}
                                        color='secondary'>
                                        <Add />
                                    </LoadingButton>
                                ...
                                <TableCell align="center">
                                    <LoadingButton
                                        ...
                                        onClick={() =>
                                            handleRemoveItem(
                                                item.productId, item.quantity, 'del' + item.productId)}
                                        color='error'>
                                        <Delete />
                                    </LoadingButton>
                                </TableCell>
            ...
            <Grid container>
                <Grid item xs={6} />
                <Grid item xs={6}>
                    <BasketSummery basketItems={basket.items} />
                    <Button
                        component={Link}
                        to='/checkout'
                        variant='contained'
